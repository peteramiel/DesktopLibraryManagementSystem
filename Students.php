...
<body >
    ...
    <h1 style="text-align: center; font-family: 'Century Gothic'; margin-top: 20px;">STUDENT LIST</h1>
 ...
 <!-- Page Content -->
    ...
    <form class="form-inline" style="margin: 0 200px 0 200px" action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST">
        <center>
        <input id="myInput" type="text" name="searchStudent" class="form-control" placeholder="Search Student Name or Student Number" size=100% autocomplete="off">
...
<table id="myTable" border="0" bgcolor = "white">
    ...
    if (!$rs_result || $rs_result->num_rows<=0) {
        ...
        echo '</table><br><br><center><h4>Student not found!</h4></center>';
