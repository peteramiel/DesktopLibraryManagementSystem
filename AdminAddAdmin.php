...
<body>
	...
	//UPLOAD TO DATABASE
	$insert = "INSERT INTO admin (name, position, section, username, password,userImage)
	VALUES ('$name', '$position', '$section', '$userName','$password','$userpic')";
		...
		if (!$dbconn->query($insert)) {
			...
			echo"<div id='myAlert' class='alert alert-success'>
			        <a href='#' class='close' data-dismiss='alert'>&times;</a>
			        <strong>Successfully added new Admin!</strong><br>
			    </div>";
		}
	} 
	?>

			<center><h1 style="font-family: 'Century Gothic';">ADMIN REGISTRATION</h1></center>
			<hr class="style15">
