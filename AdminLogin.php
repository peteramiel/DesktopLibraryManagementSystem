...
if(isset($_POST['login-admin']))
{
 ...
 $res=$dbconn->query("SELECT * FROM admin WHERE username='$username'");
...
$check = $dbconn->query("SELECT * FROM admin WHERE username = '".$_POST['username']."' AND password = '".$fetched_slash."' LIMIT 1")or die(mysql_error());
